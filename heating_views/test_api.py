...
class TestAPI(unittest.TestCase):
    ...
    def tearDown(self):
        ...
        r = requests.delete(f'{host}/devices_views/{out_sensor_name}')
        r = requests.delete(f'{host}/devices_views/{in_sensor_name}')
    ...
    def test(self):
        ...
        r = requests.post(f'{host}/devices_views', data=data)
        self.assertEqual(requests.codes.created, r.status_code, "bad response = %d" % r.status_code)
        tcount += 1
        ...
        print('test %d - get all devices_views' % tcount)
        r = requests.get(f'{host}/devices_views')
        self.assertEqual(requests.codes.ok, r.status_code, "bad response = %d" % r.status_code)
        data = r.json()
        pprint.pprint(data)
        tcount += 1
        ...
        r = requests.get(f'{host}/devices_views/{in_sensor_name}')
        self.assertEqual(requests.codes.ok, r.status_code, "bad response = %d" % r.status_code)
        data = r.json()
        pprint.pprint(data)
        tcount += 1
        ...
        r = requests.patch(f'{host}/devices_views/{in_sensor_name}', data=data)
        ...
        r = requests.post(f'{host}/devices_views/{in_sensor_name}/data', data=data)
        self.assertEqual(requests.codes.created, r.status_code, "bad response = %d" % r.status_code)
        data = {'value': '120.2', 'timestamp': tstr}
        r = requests.post(f'{host}/devices_views/{out_sensor_name}/data', data=data)
        self.assertEqual(requests.codes.created, r.status_code, "bad response = %d" % r.status_code)
        sleep(10)
        tdt = datetime.utcnow()
        ...
        r = requests.get(f'{host}/devices_views/{in_sensor_name}/data')
        self.assertEqual(requests.codes.ok, r.status_code, "bad response = %d" % r.status_code)
        data = r.json()
        pprint.pprint(data)
        tcount += 1
        ...
        print(f'test {tcount} - get data')
        targettime = savstr
        r = requests.get(f'{host}/devices_views/{in_sensor_name}/data?targettime={targettime}')
        self.assertEqual(requests.codes.ok, r.status_code, "bad response = %d" % r.status_code)
        data = r.json()
        pprint.pprint(data)
        tcount += 1
        ...
        print(f'test {tcount} - get data')
        r = requests.get(f'{host}/devices_views/{in_sensor_name}/data?targettime={targettime}&datapts=2')
        self.assertEqual(requests.codes.ok, r.status_code, "bad response = %d" % r.status_code)
        data = r.json()
        pprint.pprint(data)
        tcount += 1
        ...
        r = requests.get(f'{host}/devices_views/MECHROOM/config')
        self.assertEqual(requests.codes.ok, r.status_code, "bad response = %d" % r.status_code)
        data = r.json()
        pprint.pprint(data)
        tcount += 1
