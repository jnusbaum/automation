...
urlpatterns = [
    ...
    path('waterheaters/<heater_name>/sensors', api.sensors_for_waterheater, name='api_sensors_for_waterheater'),
    ...
    path('circpumps/<pump_name>/sensors', api.sensors_for_circpump, name='api_sensors_for_circpump'),
